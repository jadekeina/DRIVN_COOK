  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-2xl font-bold" style={{ color: "#7E6C6C" }}>
                Driv'n Cook
              </h1>
            </div>
            <h2
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {errors.email && (
                <p style={{ color: "#F87575" }} className="text-sm">
                  {errors.email}
                </p>
              )}
            </div>
      ...
      <div
        ...
        style={{ backgroundColor: "#B9E6FF" }}
      >
        <div className="text-center max-w-md">
          <div
            className="w-24 h-24 rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-xl"
            style={{ backgroundColor: "#5C95FF" }}
          >
            <svg
          ...
          <p className="text-gray-700 leading-relaxed">
            Gérez votre activité, suivez vos performances et développez votre
            business en toute autonomie avec nos outils dédiés.
          </p>
