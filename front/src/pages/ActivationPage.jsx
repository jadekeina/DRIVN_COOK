...
export default function ActivationPage() {
  ...
  const checkToken = async (tokenToCheck) => {
    try {
      const response = await fetch(
        `http://localhost:3002/api/activation/check/${tokenToCheck}`,
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3002/api/activation/activate",
        {
          method: "POST",
          headers: {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Vérification de votre lien d'activation...
          </p>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Ce lien d'activation est invalide ou a expiré. Contactez-nous si
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Votre compte franchisé a été créé avec succès. Vous pouvez
            maintenant vous connecter à votre espace.
          </p>
          <button
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Bienvenue{" "}
              <strong>
                {candidatureData?.prenom} {candidatureData?.nom}
              </strong>{" "}
              !<br />
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            Une fois activé, vous pourrez accéder à votre espace franchisé avec
