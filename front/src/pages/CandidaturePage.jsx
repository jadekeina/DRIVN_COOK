...
const CandidaturePage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.success) {
                setSubmitMessage('Candidature envoyée avec succès ! Nous vous recontacterons sous 48-72h.');
            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Rejoignez notre réseau et développez votre propre franchise Driv'n Cook.
                        ...
                        <div className="mb-12">
                            ...
                            <div className="mb-6">
                                ...
                                <select
                                    ...
                                    required
                                >
                                    <option value="">Disposez-vous d'un capital de 50 000€ ?</option>
                                ...
                                <div className="space-y-4">
                                    <label className="flex items-start gap-3 cursor-pointer">
                                        ...
                                        <span className="text-sm text-gray-700">
                                            J'accepte que mes données personnelles soient utilisées pour le traitement de ma candidature conformément à la politique de confidentialité. *
                                        </span>
                                    </label>
