...
const validators = {
    ...
    createCandidature: [
        ...
        body('commentaire_resto')
            ...
            .trim()
            .isLength({ max: 1000 })
            .withMessage('Le commentaire sur l\'expérience ne peut pas dépasser 1000 caractères'),
        ...
        body('commentaire_franchise')
            ...
            .trim()
            .isLength({ max: 1000 })
            .withMessage('Le commentaire sur l\'expérience entrepreneuriale ne peut pas dépasser 1000 caractères'),
        body('capital')
            .isIn(['oui', 'non'])
