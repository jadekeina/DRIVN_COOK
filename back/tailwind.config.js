...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        custom:
          "0 4px 6px -1px rgba(92, 149, 255, 0.1), 0 2px 4px -1px rgba(92, 149, 255, 0.06)",
        "custom-lg":
          "0 10px 15px -3px rgba(92, 149, 255, 0.1), 0 4px 6px -2px rgba(92, 149, 255, 0.05)",
      },
      animation: {
      ...
      backgroundImage: {
        ...
        "gradient-secondary":
          "linear-gradient(135deg, #FFA9A3 0%, #F87575 100%)",
